...
public class Driver {
	...
	@Bean
	public CommandLineRunner sellerDemoData(BatchService batchService, UserService userService, CarService carService, AdminService adminService) {
		return args -> {
			Batch b = new Batch();
            ...
            user1.setPhoneNumber("713-101-9999");
            ...
            user2.setPhoneNumber("713-202-9999");
            ...
            user3.setPhoneNumber("713-303-5999");
            ...
            user4.setPhoneNumber("713-404-9999");
            ...
            user5.setPhoneNumber("713-505-2999");
            ...
            user6.setPhoneNumber("713-606-9999");
