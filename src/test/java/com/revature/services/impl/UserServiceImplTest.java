...
public class UserServiceImplTest {
	...
	public void testGettingUserById() {
		...
		User expected = new User(1, "userName", new Batch(), "adonis", "cabreja", "adonis@gmail.com", "123-456-789", true, true, true);
	...
	public void testGettingUserByUsername() {
		...
		expected.add(new User(1, "userName", new Batch(), "adonis", "cabreja", "adonis@gmail.com", "123-456-789", true, true, true));
